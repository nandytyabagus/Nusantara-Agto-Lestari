<x-layouts.guest>
    <div class="flex flex-col lg:flex-row h-screen w-screen">
        ...
        <div class="hidden lg:block lg:w-1/2 relative overflow-hidden p-5 px-15">
            ...
            <div class="absolute bottom-16 right-30 text-white flex items-center gap-2">
                <img src="{{ asset('images/logo_nusantara.webp') }}" alt="logo" loading="lazy" class="w-10 h-10">
                <h1 class="font-semibold">Nusanta Agro Lestari</h1>
            </div>
        </div>
        ...
        <div class="w-full lg:w-1/2 flex items-center justify-center p-6 sm:p-10 md:p-20 lg:p-[120px] relative ">
            <div class="absolute top-8 left-39 z-10">
                <a href="{{ route('Beranda') }}"><x-heroicon-o-arrow-left class="text-logo w-8 h-8" /></a>
            </div>
