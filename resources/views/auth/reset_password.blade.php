    ...
    <div class="flex flex-col lg:flex-row h-screen w-screen">
        ...
        <div class="w-full lg:w-1/2 flex items-center justify-center p-6 sm:p-10 md:p-20 lg:p-[120px]">
            <div class="w-full max-w-md">
                ...
                <p class="text-sm text-text mb-12">Masukkan kata sandi baru Anda untuk menyelesaikan proses reset</p>

                <form action="/verify" method="post" class="space-y-8">
                    @csrf

                    <div>
                        <input type="password" name="password" id="password" placeholder="Kata Sandi"
                            class="w-full border-2 rounded-xl py-3 px-4 border-gray-300 focus:outline-none focus:border-logo">
                    </div>
